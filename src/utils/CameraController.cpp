...
void CameraController::OnUpdate(glm::vec2 mouseDelta, float scrollDelta,
                                bool rightMouseDown, bool middleMouseDown) {
...
void CameraController::Pan(glm::vec2 delta) {
  ...
  glm::vec3 offset =
      (-right * delta.x + up * delta.y) * m_PanSensitivity * m_OrbitDistance;
