...
inline const std::unordered_map<std::string, int> StringToKey = {
...
inline const std::unordered_map<int, std::string> KeyToString = {
...
inline const std::unordered_map<std::string, int> StringToMouseKey = {
...
inline const std::unordered_map<int, std::string> MouseKeyToString = {
